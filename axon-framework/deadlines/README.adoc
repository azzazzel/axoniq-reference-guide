...
| ​xref:./deadline-managers.adoc[Deadline Managers​]
| Deadline Handling using Deadline Managers

| ​xref:./event-schedulers.adoc[Event Schedulers​]
| Deadline Handling using Event Schedulers
|===
